...
The current environment (2024-2025) shows early signs of the 2021-2022 pattern's inverse: days-supply rising due to softening demand rather than falling due to scarcity, alongside unemployment and sentiment declining together for the first time since the pandemic. Because this is a different underlying mechanism than 2021-2022, the same playbook (leaning into used vehicles) should not be assumed to apply automatically, the current softening looks more like a genuine demand pullback than a supply-driven substitution opportunity, and AN's response should be evaluated on that basis rather than by analogy to the 2021–2022 experience.
